# Rank Math box: homepage (/)

Current score: 79 (Sept 26). Target: 83+.

| Field | Value |
|---|---|
| Focus Keyword | `true cost per lead` |
| Secondary keywords | `true CAC, marketing attribution, contribution margin, Allocera Intelligence` |
| SEO Title (59) | `True Cost Per Lead & True CAC for Every Campaign \| Allocera` |
| Meta Description (155) | `See your true cost per lead and true CAC for every campaign. CDAI connects your CRM and ad accounts, shows what makes money, and tells you what to do next.` |
| Schema | None (Rank Math adds the Organization and WebSite info automatically) |

## Why it's at 79
Measured on `website/homepage.html`:
- The keyword appears only 5 times in about 2,270 words (Rank Math wants about 1%).
