# Rank Math box: /blog/ (Page ID 187)

Search Console: 95 impressions in the last 3 months, average position 16.4.

The old hub carried:
- the retired 80% claim
- "seven cost layers" on many cards
...
- `/seven-cost-layers/`
- `/55-directives-study/`
- `/30-day-retest-methodology/` and `-2/`
- `/true-cac-2/`
